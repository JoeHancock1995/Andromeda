...
(function () {
  document.forms.contactForm.noValidate = true; // Disable HTML5 validation - using JavaScript instead
  // -------------------------------------------------------------------------
  ...
  $('form').on('submit', function (e) {      // When form is submitted
    ...
    // if (!validateTattooIdea()) {                // Call validateTattooIdea(), and if not valid
    //   showErrorMessage(document.getElementById('tattooIdea')); // Show error message
    //   valid.tattooIdea = false;                 // Update valid object - this element is not valid
    // } else {                             // Otherwise remove error message
    //   removeErrorMessage(document.getElementById('tattooIdea'));
    // }
  ...
  // function validateTattooIdea() {
  //   var tattooIdea = document.getElementById('tattooIdea');
  //   var valid = tattooIdea.value.length <= 140;
  //   if (!valid) {
  //     setErrorMessage(tattooIdea, 'Please make sure your tattoo description does not exceed 140 characters');
  //   }
  //   return valid;
  // }
